define("mod_pulse/automation", ['jquery', 'core/modal', 'core/templates', 'core/str', "core/notification"],
    function ($, Modal, Template, Str, notification) {
        ...
        const returnToFailedTab = () => {
            ...
            const failedTab = () => {
                var invalidElement = document.forms['pulse-automation-template'].querySelector('.is-invalid');
            ...
            // Return to the failed element tab on submit.
            document.forms['pulse-automation-template'].querySelector('[name="submitbutton"]').onclick = () => {
                failedTab();
                return true;
            };
