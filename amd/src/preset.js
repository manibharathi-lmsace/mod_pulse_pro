define(['jquery', 'mod_pulse/events', 'core/str', 'core/fragment', 'core/ajax',
    'core/templates', 'core/loadingicon', 'core/notification', 'core/modal_events', 'mod_pulse/presetmodal'],
    function ($, PresetEvents, Str, Fragment, AJAX, Templates, Loadingicon,
        ...
        Preset.prototype.setupmodal = function () {
            ...
            triggerelement.forEach((element) => element.addEventListener('click', () => {
                ...
                if (typeof PresetModal.registerModalType == 'undefined') {
                    modalFn = new Promise(function(resolve, reject) {
                        require(['core/modal_factory', 'mod_pulse/modal_preset'], function(Modal, ModalPreset) {
                            Modal.create({
        ...
        Preset.prototype.reinitAvailability = function (selector = '.availability-field') {
            if (typeof M.core_availability !== "undefined" &&
                typeof M.core_availability.form !== "undefined" &&
