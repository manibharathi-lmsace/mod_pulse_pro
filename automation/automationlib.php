...
require_once($CFG->dirroot . '/mod/pulse/automation/template_table_filter.php');
require_once($CFG->dirroot . '/mod/pulse/automation/context_course.php');
require_once($CFG->dirroot . '/mod/pulse/automation/context_module.php');
require_once($CFG->dirroot . '/mod/pulse/automation/instance_table_filter.php');
