...
require(['jquery', 'core/str', 'mod_pulse/events', 'mod_pulse/presetmodal'],
    function($, Str, PresetEvents, PresetModal) {
        ...
        switche.querySelector('.custom-switch').addEventListener('click', function(e) {
            ...
            if (typeof PresetModal.registerModalType == 'undefined') {
                modalFn = new Promise(function(resolve, reject) {
                    require(['core/modal_factory', 'mod_pulse/modal_preset'], function(ModalFactory, ModalPreset) {
                        ModalFactory.create({
