...
class pulseaction extends base {
    ...
    public function load_settings(part_of_admin_tree $adminroot, $parentnodename, $hassiteconfig) {
        ...
        // Action plugin settings display name.
        $displayname = $this->displayname;
        if (get_string_manager()->string_exists('plugin:settingname', $this->component)) {
            $displayname = new lang_string('plugin:settingname', $this->component);
        }

        $settings = new admin_settingpage($section, $displayname, 'moodle/site:config', $this->is_enabled() === false);
