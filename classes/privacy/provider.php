...
class provider implements core_plugin_provider, core_privacy_provider, core_userlist_provider {
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        // Subplugin types — each subplugin manages its own user data.
        $collection->add_plugintype_link('pulseaction', [], 'privacy:metadata:pulseaction');
        $collection->add_plugintype_link('pulsecondition', [], 'privacy:metadata:pulsecondition');
        $collection->add_plugintype_link('pulseaddon', [], 'privacy:metadata:pulseaddon');
