...
class templates {
    ...
    protected function get_template_record() {
        ...
        $data->tenants = $data->tenants ? json_decode($data->tenants) : [];
    ...
    public function get_data_forinstance(&$instance) {
        ...
        $data->tags = $data->tags ? json_decode($data->tags) : [];
    ...
    public static function get_templates_record($templates) {
        ...
        [$insql, $inparams] = $DB->get_in_or_equal($templates, SQL_PARAMS_NAMED, 'ins');
